...
<section class="preFooter">
  <div class="myName move down"><i class="fas fa-angle-double-down fa-2x"></i></div>
  <div class="myName move up" style="display:none;"><i class="fas fa-angle-double-up fa-2x"></i></div>
</section>
